...
$shortcutPath = Join-Path $desktop ('Alpha 6 OPS - ' + $View + '.lnk')
...
$shortcut.Arguments = '-NoProfile -ExecutionPolicy Bypass -WindowStyle Hidden -File "' + $launcherScript + '" -View ' + $View
...
$shortcut.Description = if ($View -eq 'Dashboard') {
    'Build and open the latest Alpha 6 OPS desktop dashboard, or restore the running desktop app.'
} else {
    'Build the latest Alpha 6 OPS development preview. Always starts at login; choose Flying as a Pilot to continue.'
}
